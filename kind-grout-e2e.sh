...
IMG_TAG=main-grout make grout-docker-build load-on-kind
...
make e2etests GINKGO_ARGS="-failFast --label-filter=grout-support" TEST_ARGS="--groutmode" > $t/console.out
